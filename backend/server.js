...
if (!RAZORPAY_KEY_ID || !RAZORPAY_KEY_SECRET || !RAZORPAY_WEBHOOK_SECRET || !SUPABASE_URL || !SUPABASE_SERVICE_ROLE_KEY) {
...
let entity = payload?.payload?.payment_link?.entity || null;
    let paymentEntity = payload?.payload?.payment?.entity || null;
